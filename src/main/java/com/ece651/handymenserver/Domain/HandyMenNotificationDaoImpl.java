...
public class HandyMenNotificationDaoImpl implements HandyMenNotificationDao {
	...
	public void deleteHandyMenNotification(String usrName, HandyMenNotification.TypeEnum notificationType,
			String timeStamp) throws Exception {
    	String deleteSql = "delete from " + notificationTblName + 
    			" where usrName = ? and timeStamp = ? "
    			+ "and notificationType = ? ";
    	jdbcTemplate.update(deleteSql, new Object[]{usrName, timeStamp, notificationType.toString()});		
